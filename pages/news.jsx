...
const SEO_COLUMN_SEEDS = [
  ...
  ["2026.05.28", "人口減少で地域需要が減る会社は、どう事業を残すべきか", "人口減少と地域需要の縮小", "地域需要・採用・取引先・固定費の変化を早めに見える化する"],
  ...
  ["2026.04.16", "売上が減ってきた地方企業が、廃業前に確認すべきこと", "売上減少と取引先減少", "売上構成、粗利、固定費、主要顧客依存度を確認する"],
...
function getCustomSeoColumnOverride(index, title, issue, action) {
  if (index === 1) {
    return {
      metaTitle: "人口減少で地域需要が減る会社はどう事業を残すべきか | NexusM&A",
      metaDescription: "人口減少で地域需要・採用・取引先が縮小する地方企業向けに、単独継続、縮小、提携、第三者承継、M&Aを比較する考え方を解説します。",
      excerpt: "人口減少で地域需要が減る会社は、売上だけでなく採用、取引先、固定費、後継者候補を同時に確認する必要があります。事業を残す選択肢を整理します。",
      body: [
        { type: "lead", text: "人口減少は、地域の中小企業にとって遠い社会問題ではありません。売上、採用、取引先、従業員の年齢構成、後継者候補のすべてに少しずつ影響し、気づいたときには選択肢が狭くなっていることがあります。" },
  ...
  if (index === 4) {
    return {
      metaTitle: "売上が減ってきた地方企業が廃業前に確認すべきこと | NexusM&A",
      metaDescription: "地方で売上や取引先が減ってきた中小企業向けに、廃業を決める前に確認したい売上構成・粗利・固定費・主要顧客依存・事業承継の選択肢を解説します。",
      excerpt: "売上が減ってきた地方企業が、廃業を決める前に確認すべき数字と選択肢を整理します。縮小、提携、第三者承継、M&Aを比較する前の実務ポイントです。",
      body: [
        { type: "lead", text: "地方で売上が減ってきたとき、すぐに廃業を決める必要はありません。先に確認すべきことは、売上全体が落ちているのか、特定の取引先・商品・地域だけが落ちているのかを分けることです。" },
