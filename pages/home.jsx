...
function PageHome({ navigate }) {
  ...
  const news = [
    ...
    { tag: "コラム", date: "2025.11.20", title: "事業承継税制の改正ポイント — 経営者が今押さえるべき3つの論点" },
    { tag: "コラム", date: "2025.04.10", title: "M&Aを検討し始めたら、最初にやるべき5つのこと" },
    { tag: "お知らせ", date: "2020.11.01", title: "M&A・事業承継に関する相談業務開始のお知らせ" },
  ];
